...
int main() {
    ...
    printf("Unsigned float MIN = %d\tMAX = %d\n", 0, ); //WARN: UNSIGNED FLOAT ???

    //NOTE: DOUBLE VALUES
    printf("\nSigned double MIN = %d\tMAX = %d\n", DBL_MIN, DBL_MAX);
    printf("Unsigned double MIN = %d\tMAX = %d\n", 0, ); //WARN: UNSIGNED DOUBLE ???

    //NOTE: LONG DOUBLE VALUES
    printf("\nSigned long dooble MIN = %d\t MAX %d\n", LDBL_MIN, LDBL_MAX);
    printf("Unsigned long double MIN = %d\tMAX = %d\n", 0, ); //WARN: UNSIGNED LONG DOUBLE ???
